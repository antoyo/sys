...
pub type GAsyncQueue_autoptr = gpointer;
pub type GBookmarkFile_autoptr = gpointer;
pub type GByteArray_autoptr = gpointer;
pub type GBytes_autoptr = gpointer;
pub type GChecksum_autoptr = gpointer;
pub type GDateDay = u8;
pub type GDateTime_autoptr = gpointer;
pub type GDateYear = u16;
pub type GDir_autoptr = gpointer;
pub type GError_autoptr = gpointer;
pub type GHashTable_autoptr = gpointer;
pub type GHmac_autoptr = gpointer;
pub type GIOChannel_autoptr = gpointer;
pub type GKeyFile_autoptr = gpointer;
pub type GList_autoptr = gpointer;
pub type GMainContext_autoptr = gpointer;
pub type GMainLoop_autoptr = gpointer;
pub type GMappedFile_autoptr = gpointer;
pub type GMarkupParseContext_autoptr = gpointer;
pub type GMatchInfo_autoptr = gpointer;
pub type GMutexLocker = gpointer;
pub type GMutexLocker_autoptr = gpointer;
pub type GNode_autoptr = gpointer;
pub type GOptionContext_autoptr = gpointer;
pub type GOptionGroup_autoptr = gpointer;
pub type GPatternSpec_autoptr = gpointer;
pub type GPid = c_int;
pub type GPtrArray_autoptr = gpointer;
pub type GQuark = u32;
pub type GQueue_autoptr = gpointer;
pub type GRand_autoptr = gpointer;
pub type GRegex_autoptr = gpointer;
pub type GSList_autoptr = gpointer;
pub type GScanner_autoptr = gpointer;
pub type GSequence_autoptr = gpointer;
pub type GSource_autoptr = gpointer;
pub type GStringChunk_autoptr = gpointer;
pub type GStrv = gpointer;
pub type GThread_autoptr = gpointer;
pub type GTime = i32;
pub type GTimeSpan = i64;
pub type GTimeZone_autoptr = gpointer;
pub type GTimer_autoptr = gpointer;
pub type GTree_autoptr = gpointer;
pub type GType = size_t;
pub type GVariantBuilder_autoptr = gpointer;
pub type GVariantDict_autoptr = gpointer;
pub type GVariantIter_autoptr = gpointer;
pub type GVariantType_autoptr = gpointer;
pub type GVariant_autoptr = gpointer;
...
pub const G_HAVE_INLINE: i32 = 1;
pub const G_HAVE_ISO_VARARGS: i32 = 1;
pub const G_HAVE___INLINE: i32 = 1;
pub const G_HAVE___INLINE__: i32 = 1;
...
pub const GLIB_MICRO_VERSION: i32 = 1;
...
pub const GLIB_MINOR_VERSION: i32 = 44;
...
pub const G_POLLFD_FORMAT: &'static str = r##"%#I64x"##;
...
extern "C" {
    ...
    pub fn g_compute_hmac_for_data(digest_type: GChecksumType, key: *mut u8, key_len: size_t, data: *const u8, length: size_t) -> *mut c_char;
